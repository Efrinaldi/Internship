    ...
    <div class="register-box-body">
      ...
      <form action="<?= base_url() ?>/reg" method="post">
        <div class="form-group has-feedback">
          <input type="text" id="InputForFirstName" name="first_name" class="form-control" placeholder="First name">
          <span class="glyphicon glyphicon-user form-control-feedback"></span>
        </div>

        <div class="form-group has-feedback">
          <input type="text" id="InputForLastName" name="last_name" class="form-control" placeholder="Last name">
          <span class="glyphicon glyphicon-user form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
        ...
        <div class="form-group has-feedback">
          <input type="text" id="InputForUnitKerja" name="unit_kerja" class="form-control" placeholder="Unit Kerja">
          <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        </div>
