                ...
                <table class="table table-dark">
                    ...
                    <tbody class="text-center">
                        ...
                        foreach ($data_user as $o) :
                                ...
                                <div class=" modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="<?= base_url("/hapus_satker/" . $o["userid"]) ?>" class="btn btn-primary" type="submit" name="submit">Hapus</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form class="forms-sample" action="<?= base_url("/change_satker/" . $o["userid"]) ?>" method="POST">
