...
<head>
    ...
    <title>BCA Syariah - Reimbursement</title>
        ...
        <div class="main-wrapper">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="<?= site_url('homes'); ?>">Reimburse Driver</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?= site_url('homes'); ?>">RMB</a>
                    </div>
            ...
            <footer class="main-footer">
                <div class="footer-right">
                    <div class="bullet"></div> Developed by <a href="https://bcasyariah.co.id">BCA Syariah</a>
                </div>
                <!-- <div class="footer-right">
                    1.0.0
                </div> -->
