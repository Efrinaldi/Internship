...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="container-xl ">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <h5 for="plat_nomor"><?php echo $data["plat_nomor"] ?></h5>
                            <h5 for="keterangan_mobil"><?php echo $data["keterangan_mobil"] ?></h5>
                    ...
                    <div class="card mb-4">
                        <div class="card-header col-md-12 d-inline-flex">
                            ...
                            <div class="d-flex justify-content-end col-md-6">
                                <a class="btn btn-primary col-md-6 mr-2" data-toggle="modal" data-target="#perjalananSelesai<?= $data['id_pemesanan'] ?>" style="color:white;height:60px;max-height:80px; justify-content:center;align-items: center;">Perjalanan <br> Selesai</a>
                                <a class="btn btn-secondary col-md-6 " data-toggle="modal" data-target="#perjalananTerlambat<?= $data['id_pemesanan'] ?>" style="color:white;height:60px;max-height:80px; justify-content:center;align-items: center;">Perjalanan <br> Terlambat</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <form>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputPhone">Keterangan Mobil</label>
                                        <input type="text" id="plat_nomor" value="<?= $data["keterangan_mobil"] ?>" name="plat_nomor" width="276" class="form-control file-upload-info" readonly required />
                                    </div>
                                    <!-- Form Group (birthday)-->
                                    <div class="col-md-6">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="waktu" id="waktu" value="<?= $data["tanggal"] . "  " . $data["waktu"] ?>" readonly required />
                                    </div>
                                    <!-- Form Group (location)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputLocation">Waktu Berakhir</label>
                                        <input type="text" class="form-control" name="waktu_end" id="waktu_end" value="<?= $data["tanggal"] . "  " . $data["waktu_end"] ?>" readonly required />
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" type="submit" onclick="success()" name="submit">OK </a>
                            </form>
                        </div>
            ...
            <div class="modal fade in" tabindex="-1" role="dialog" id="perjalananSelesai<?= $data['id_pemesanan'] ?>">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                            <a onclick="reject(<?php echo $data['id_pemesanan'] ?>)" class="btn btn-primary" type="submit" name="submit">OK </a>
                            </form>
                        </div>
            ...
            <div class="modal fade in" tabindex="-1" role="dialog" id="perjalananTerlambat<?= $data['id_pemesanan'] ?>">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 id="b" class="modal-title">Perpanjangan waktu perjalanan</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="exampleFormControlTextarea1" class="form-label">Keterlambatan sampai dengan jam ?</label>
                                <div class="form-group row">
                                    <div class="col-md-12 input-group date" id="timepickerEnd" data-target-input="nearest">
                                        <input type="time" class="form-control datetimepicker-input" name="inputWaktuEnd" id="inputWaktuEnd" />
                                    </div>
                        ...
                        <div class="modal-footer">
                            <a onclick="perjalanan_terlambat(<?php echo $data['id_pemesanan'] ?>)" class="btn btn-primary" type="submit" name="submit">OK </a>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <?php if ($data["keterangan"] === "end") : ?>
                <div class="track">
                    <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Telah Diterima</span> </div>
                    <div class="step active"> <span class="icon"> <i class="fa fa-user"></i> </span> <span class="text"> Di approve oleh Supervisor</span> </div>
                    <div class="step active"> <span class="icon"> <i class="fa fa-user"></i> </span> <span class="text"> Di approve oleh logistik </span> </div>
                    <div class="step active"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text">Driver menjemput anda</span> </div>
                    <div class="step active"> <span class="icon"> <i class="fa fa-ban"></i> </span> <span class="text">Perjalanan Selesai</span> </div>
...
<script>
    function perjalanan_terlambat(id) {
        var inputWaktuEnd = document.getElementById("inputWaktuEnd").value
        var html = '';
        $.ajax({
            url: "<?php echo site_url('/perjalanan_terlambat/'); ?>" + id,
            method: "POST",
            data: {
                inputWaktuEnd: inputWaktuEnd
            },
            async: true,
            dataType: "JSON",
