                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-primary" type="submit" name="submit" onclick="<?php echo "approvalSpv(" . $o["id_order"] . ")" ?>" class="btn btn-info mb-3">Submit SPV</a>
                                            </form>
                                        </div>
...
<script type="text/javascript">
    ...
    function approvalSpv(v) {
        var div = $('#dept').val();
        var id = document.getElementById("dept").value;
        var spv = document.getElementById("spv").value;
        console.log(id);
        $.ajax({
