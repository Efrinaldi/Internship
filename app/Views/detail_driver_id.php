...
<body>
                    ...
                    <div class="container rounded bg-white mt-5 mb-5">
                        <div class="row">
                            <div class="col-md-3 border-right">
                                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><span class="font-weight-bold"><?php echo $pengemudi["nama_pengemudi"] ?></span><span class="text-black-50"></span><span><?php echo $mobil["plat_nomor"] ?></span></div>
                            </div>
                            <div class="col-md-9">
                                <div class="p-3 py-5">
                                    <a class="mb-3" href="<?= base_url("driver") ?>"><i class="fa fas fa-arrow-left"></i>Kembali ke daftar driver</a>

                                    <div class="d-flex justify-content-between align-items-center mb-3 mt-5">
                                        <h4 class="text-right">Profil Pengemudi</h4>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-6"><label class="labels">Nama Pengemudi</label><input type="text" class="form-control" placeholder="Nama Pengemudi" value="<?php echo $pengemudi["nama_pengemudi"] ?>"></div>
                                        <div class="col-md-6"><label class="labels">Plat Mobil</label><input type="text" class="form-control" value="<?php echo $mobil["plat_nomor"] ?>" placeholder="Plat Nomor"></div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-12"><label class="labels">Jenis Mobil</label><input type="text" class="form-control" placeholder="Jenis Mobil" value="<?php echo $mobil["keterangan_mobil"] ?>"></div>
                                        <div class=" col-md-12"><label class="labels">Kapasitas Mobil</label><input type="text" class="form-control" placeholder="Kapasitas Mobil" value="<?php echo $mobil["kapasitas_mobil"] ?>"></div>
                                        <div class="col-md-12"><label class="labels">Nomor Handphone</label><input type="text" class="form-control" placeholder="Nomor Handphone" value="<?php echo $pengemudi["phone_number"] ?>"></div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-6"><label class="labels">Status Mobil</label><input type="text" class="form-control" placeholder="Status Mobil" value="<?php echo $mobil["status_mobil"] ?>"></div>
                                        <div class="col-md-6"><label class="labels">Status Pengemudi</label><input type="text" class="form-control" placeholder="Status Pengemudi" value="<?php echo $pengemudi["status_pengemudi"] ?>"></div>
                                    </div>
    ...
    <script src="<?= base_url('/public/assets_d/js/core/popper.min.js') ?>"></script>
    <script src="<?= base_url('/public/assets_d/js/core/bootstrap.min.js') ?>"></script>
    <script src="<?= base_url('/public/assets_d/assets/js/plugins/perfect-scrollbar.min.js') ?>"></script>
